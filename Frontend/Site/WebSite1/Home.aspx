...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        <asp:GridView ID="roomsGridView" runat="server" AutoGenerateColumns="False" Height="420px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ViewStateMode="Enabled" Visible="False" Width="989px" AutoGenerateSelectButton="True" CssClass="table">
            <Columns>
    ...
    <h2 id="buildingHeader">
        <asp:Label ID="Label1" runat="server" CssClass="labelLame" Text="Building"></asp:Label>
        &nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="buildingDropDownList" runat="server" DataTextField="building" DataValueField="building" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" DataSourceID="buildings" ForeColor="Black">
...
&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="timeDropDownList" runat="server" Enabled="False" OnSelectedIndexChanged="timeDropDownList_SelectedIndexChanged" Visible="False" AutoPostBack="True" ForeColor="Black">
        </asp:DropDownList>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
